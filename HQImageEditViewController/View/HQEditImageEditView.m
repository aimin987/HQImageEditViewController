...
- (UIView *)imageWrap {
    if (!_imageWrap) {
        ...
        NSString *top_left_Str = @"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEgAAABIAQMAAAEYJBGSAAAABGdBTUEAALGPC/xhBQAAAAZQTFRFAAAA////pdmf3QAAAAF0Uk5TAEDm2GYAAABISURBVCjPY/jfwABEBxiwIIhUAwMW9P//AYYHDAx4MUgNDANNIxv/B4IPUPIHAwjQjkS2C5P8AFYzFMn/MECI1cAABaMsMlgAaXTOtStXpPkAAAAASUVORK5CYII=";
        NSString *bottom_left_Str = @"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEgAAABIAQMAAAEYJBGSAAAABGdBTUEAALGPC/xhBQAAAAZQTFRFAAAA////pdmf3QAAAAF0Uk5TAEDm2GYAAABGSURBVCjPYzjAwIAV/W9gaGDAjoBSDxgY8OL//w+ADKEIg8wA4R8MIEA78j8QfICSH8AiQ5dE9gsK2cAABaMsElgwQCwLABHsznWFjxcoAAAAAElFTkSuQmCC";
        NSString *bottom_right_str = @"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEgAAABIAQMAAAEYJBGSAAAABGdBTUEAALGPC/xhBQAAAAZQTFRFAAAA////pdmf3QAAAAF0Uk5TAEDm2GYAAABASURBVCjPY2BoYMCK/uMQh0oxHMCL//8/QFANMWZAzGFg+EBD8j8QwEggYBzKJLJf0PwFVvF/lEUC6z8MEMsCACjDu7R7SncZAAAAAElFTkSuQmCC";
        NSString *top_right_str = @"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEgAAABIAQMAAAEYJBGSAAAABGdBTUEAALGPC/xhBQAAAAZQTFRFAAAA////pdmf3QAAAAF0Uk5TAEDm2GYAAAA+SURBVCjPY/jfwABEDNgQPqn/BxgYGPBjkBoYJqQWvzn//3+AkiBASxLZLkwSCBiHJvkfBgiwoIBxlEUWCwC/Rru0T+WCjQAAAABJRU5ErkJggg==";
        
        UIImageView *topLeft = [[UIImageView alloc] initWithImage:[self decodeBase64ToImage:top_left_Str]];
        topLeft.tag = 0;
        ...
        UIImageView *topright = [[UIImageView alloc] initWithImage:[self decodeBase64ToImage:top_right_str]];
        topright.tag = 1;
        ...
        UIImageView *bottomLeft = [[UIImageView alloc] initWithImage:[self decodeBase64ToImage:bottom_left_Str]];
        bottomLeft.tag = 2;
        ...
        UIImageView *bottomRight = [[UIImageView alloc] initWithImage:[self decodeBase64ToImage:bottom_right_str]];
        bottomRight.tag = 3;
